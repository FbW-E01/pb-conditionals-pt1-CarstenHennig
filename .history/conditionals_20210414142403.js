...
let numSeven = 0;
let numEight = 6;
if ((numSeven+numEight === numSeven) || (numSeven+numEight === numEight)) {
    console.log("Result is: " + (numSeven+numEight)*3);
}
else {
...
let numTen = Math.floor(Math.random() * 30);
let mySum = 19 - numTen;
console.log(numTen);
console.log(mySum);
if (numTen > 19) {
    console.log("Exactly calculated: " + mySum * 2);
}
else {
    console.log("Try again");
}

// 11. BONUS CHALLENGE:  Make a variable for firstName and age and give each variable values. Create an if/else statement to check whether the person's age is less than 13. If so, print "firstName is a child". If the age is equal to or more than 13 and less than 20, print "firstName is a teenager". 
